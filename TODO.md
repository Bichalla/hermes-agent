...
- [x] Patch Graphify hidden-path allowlisting via `.graphifyinclude` so curated `.hermes/` operating docs remain SSOT and are indexed.
...
- [ ] Decide whether to patch Graphify watch ignore/include handling.
