...
class TestApprovalTimeoutIsNotConsent:
    ...
    def setup_method(self):
        ...
        mod._pending.clear()
        # Earlier gateway tests can leave a context-local session key bound in
        # this pytest context. Bind this test's key explicitly so callback
        # lookup is deterministic, then restore the prior value in teardown.
