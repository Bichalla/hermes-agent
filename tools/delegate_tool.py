...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "public-facing commands. Existing Kanban card status-memory metadata — "
        "comments, progress notes, repo/PR/artifact links, verification summaries, "
        "and handoff notes attached to an existing or already-approved task — "
        "does not require separate approval when it does not create new work, "
        ...
        "actions. If approval is missing, stale, ambiguous, or only implied by a "
        "plan/handoff, do not perform the mutation. Return an approval-needed summary "
        "naming the action, target, risk, and verification you would run after approval."
    )
    parts.append(
