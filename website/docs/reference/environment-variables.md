...
| `HERMES_LOCAL_STT_INITIAL_PROMPT` | Optional initial prompt passed to local faster-whisper to bias rare names/wake words when `stt.local.initial_prompt` is not set |
